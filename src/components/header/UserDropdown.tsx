...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex items-center justify-center mr-3 text-white bg-brand-500 rounded-full h-11 w-11">
          {userInitials}
        </span>
        <span className="block mr-1 font-medium text-theme-sm">{userFirstName}</span>
        <svg
      ...
      {/* FIX: The ref is now on a plain div that wraps the Dropdown component */}
      <div ref={dropdown}>
        <Dropdown
          isOpen={isOpen}
