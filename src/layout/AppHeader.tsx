  ...
  return (
    <header className="sticky top-0 z-50 flex w-full bg-white border-b border-gray-200 dark:border-gray-800 dark:bg-gray-900">
      <div className="flex items-center justify-between grow lg:px-6">
        {/* Left side: Sidebar Toggle and Mobile Logo */}
        ...
        <div className="flex items-center gap-4 px-5 py-4 lg:py-0">
          <div className="flex items-center gap-2 2xsm:gap-3">
            <ThemeToggleButton />
          </div>

          {/* FIX: Removed the props. The component now gets user data from the AuthContext. */}
          <UserDropdown />
